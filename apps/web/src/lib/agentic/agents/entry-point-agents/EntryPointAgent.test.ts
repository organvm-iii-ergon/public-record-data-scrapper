...
describe('EntryPointAgent', () => {
  ...
  describe('analyze()', () => {
    ...
    it('should suggest latency optimization for slow endpoints', async () => {
      ...
      const latencySuggestion = analysis.improvements.find((i) => i.title.includes('performance'))
    ...
    it('should suggest cost optimization for expensive endpoints', async () => {
      ...
      const costSuggestion = analysis.improvements.find((i) => i.title.includes('costs'))
    ...
    it('should not suggest improvements for healthy endpoints', async () => {
      ...
      const performanceImprovements = analysis.improvements.filter((i) => i.priority === 'critical')
