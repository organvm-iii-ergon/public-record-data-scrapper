...
body {
  background: linear-gradient(
    ...
    /* Deep navy */ oklch(0.2 0.06 240) 25%,
    /* Darker navy */ oklch(0.18 0.05 230) 50%,
    /* Darkest */ oklch(0.22 0.07 245) 75%,
    /* Medium navy */ oklch(0.25 0.08 250) 100% /* Deep navy */
  );
}
```
...
--warning-foreground: oklch(0.2 0.05 250);
```
...
```css
.health-grade-f {
  background: oklch(0.4 0.35 15 / 0.3);
  color: oklch(0.98 0.002 0);
  border-color: oklch(0.4 0.35 15);
}
```
...
```css
--chart-1: oklch(0.65 0.3 45); /* Primary amber */
--chart-2: oklch(0.65 0.14 210); /* Secondary cyan */
--chart-3: oklch(0.7 0.15 60); /* Accent gold */
--chart-4: oklch(0.55 0.32 200); /* Deep blue */
--chart-5: oklch(0.45 0.3 320); /* Purple */
```

### Extended Palette (10 colors for complex charts)

```css
--chart-6: oklch(0.6 0.15 145); /* Green */
--chart-7: oklch(0.7 0.2 25); /* Orange */
--chart-8: oklch(0.75 0.15 75); /* Yellow */
--chart-9: oklch(0.5 0.25 180); /* Teal */
...
.gradient-primary {
  background: linear-gradient(
    135deg,
    oklch(0.65 0.3 45) 0%,
    oklch(0.7 0.25 50) 50%,
    oklch(0.7 0.15 60) 100%
  );
}
```
...
```css
.gradient-success {
  background: linear-gradient(135deg, oklch(0.6 0.15 145) 0%, oklch(0.65 0.12 155) 100%);
}
```
...
.gradient-mesh {
  background:
    radial-gradient(at 0% 0%, oklch(0.3 0.1 250 / 0.3) 0, transparent 50%),
    radial-gradient(at 100% 0%, oklch(0.3 0.08 240 / 0.2) 0, transparent 50%),
    ...
    linear-gradient(135deg, oklch(0.25 0.08 250) 0%, oklch(0.2 0.06 240) 100%);
}
```
...
```css
box-shadow: 0 0 20px oklch(0.65 0.3 45 / 0.3);
```
...
```css
box-shadow: 0 0 15px oklch(0.6 0.15 145 / 0.4);
```
